    ...
    <div class="col-md-9 col-lg-10 ml-md-auto px-0 ms-md-auto">
        ...
        <div class="container">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody id="disapproved-bakeshops">
        ...
        $(document).ready(function () {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#disapproved-bakeshops').html(rows);

                    // Attach click event to the photo links
                ...
                error: function () {
                    $('#disapproved-bakeshops').html('<tr><td colspan="10">Failed to load data.</td></tr>');
                }
            });
        });
    </script>
