...
<body>
    ...
    <h1 class="bi text-primary d-flex justify-content-center">
        ...
        <div class="list-group rounded-0">
            ...
            <a href="users.php" class="list-group-item list-group-item-action active border-0 d-flex align-items-center">
    ...
    <div class="col-md-9 col-lg-10 ml-md-auto px-0 ms-md-auto">
        ...
        if (isset($_GET['status'])) {
            ...
            if ($status == 'deleted') {
                ...
                echo '<div class="alert alert-danger">There was an error deleting the user. Please try again.</div>';
            }
        }
        ?>
